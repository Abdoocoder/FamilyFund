...
const INJECTED_STYLES = `
  ...
  .btn-modern-light {
      background: linear-gradient(180deg, #FFFFFF 0%, var(--color-muted-surface) 100%);
      color: var(--color-foreground);
  ...
  .btn-modern-light:active {
      ...
      background: linear-gradient(180deg, var(--color-muted-surface) 0%, var(--color-border) 100%);
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#4a8bff" strokeWidth="12" />
                        </svg>
